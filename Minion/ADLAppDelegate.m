...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    ADLMasterViewController *masterViewController = [[ADLMasterViewController alloc] initWithNibName:@"ADLMasterViewController" bundle:nil];
    UINavigationController *masterNavigationController = [[UINavigationController alloc] initWithRootViewController:masterViewController];

    ADLDetailViewController *detailViewController = [[ADLDetailViewController alloc] initWithNibName:@"ADLDetailViewController" bundle:nil];
